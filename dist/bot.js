...
export class Bot {
    ...
    updateCommandsForGuild(partialGuild) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!partialGuild)
                return;
            let guild;
            try {
                guild = yield partialGuild.fetch();
            }
            catch (fetchError) {
            ...
            if (!guildFlags) {
                ...
                try {
                    ...
                    yield this.db.saveFlags(guild.id, this.defaultFlags);
            ...
            try {
                yield guild.commands.set(enabledBuilds);
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(syncPromises).then(() => logger.log("Comandos carregados"));
            ...
            for (const event of this.events) {
                if (event.once) {
                    ...
                    this.client.once(event.name, (...args) => __awaiter(this, void 0, void 0, function* () { return yield event.execute(...args); }));
                }
                else {
                    // Para eventos como 'InteractionCreate'
                    this.client.on(event.name, (...args) => __awaiter(this, void 0, void 0, function* () { return yield event.execute(...args); }));
                }
            }
