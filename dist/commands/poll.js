...
import { MessageFlags, PermissionFlagsBits, PollLayoutType, SlashCommandBuilder } from 'discord.js';
...
export class PollCommand extends BaseCommand {
    constructor() {
        super(new SlashCommandBuilder()
            ...
            .setRequired(true)
            .addChoices({ name: '1 hora', value: 1 }, { name: '2 horas', value: 2 }, { name: '6 horas', value: 6 }, { name: '12 horas', value: 12 }, { name: '1 dia', value: 24 }, { name: '3 dias', value: 72 }, { name: '5 dias', value: 120 }, { name: '7 dias', value: 168 }, { name: '14 dias', value: 336 }))
            ...
            .setRequired(false)
            .setMaxLength(55))
            .addIntegerOption(option => option.setName('allow-multiselect')
    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield interaction.reply({ content: "✅ Enquete criada com sucesso!", flags: MessageFlags.Ephemeral });
            }
            catch (error) {
