...
export const CHAT_CHANNEL_NAME = '💬│bate-papo';
...
export const CLASS_CHANNELS = [
    { name: '🙋│apresente-se', type: 'text', position: 0 },
    { name: WARNING_CHANNEL_NAME, type: 'text', position: 1, restrictStudents: true },
    { name: CHAT_CHANNEL_NAME, type: 'text', position: 2 },
...
export const STUDENT_ROLE_PERMISSIONS = [
...
export const STUDENTS_NORMAL_CHANNEL_PERMISSIONS = {
    allow: [PermissionFlagsBits.ViewChannel],
    deny: [PermissionFlagsBits.SendPolls],
};

export const STUDENTS_STRICT_CHANNEL_PERMISSIONS = {
    allow: [PermissionFlagsBits.ViewChannel],
    deny: [PermissionFlagsBits.SendPolls, PermissionFlagsBits.SendMessages],
};

export const PROFESSOR_ROLE_NAMES = ['Equipe Pós-Tech', 'Talent Lab', 'Gestor acadêmico', 'Coordenação', 'Professores'];

// Use {mention} in the content to mention the student role in the initial forum posts
