export const defaultEventDescription: { [key: string]: string } = {
    "Grupo de estudos": "Olá, turma!\n" +
        ...
        "\n" +
        "Segue o link para o grupo de estudos: {link}\n" +
        "\n" +
        "Não perca o bate papo do Grupo de Estudos!\n" +
        " \n" +
        "Obs: Este momento não será gravado\n",
    "Live": `Lembre-se que a live será no Zoom através do link: {link}\n` +
        "\n" +
    ...
    "Mentoria": "Olá, turma!\n" +
        ...
        " \n" +
        "Obs: Este momento não será gravado",
    "Hackaton": "Preparem o café e os teclados! 🚀\n" +
        "\n" +
