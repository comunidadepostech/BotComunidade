...
export class EventCommand extends BaseCommand {
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        ...
        const startDate: string = interaction.options.getString('start-date')!;
        const startTime: string = interaction.options.getString('start-time')!;
        const endDate: string = interaction.options.getString('end-date')!;
        const endTime: string = interaction.options.getString('end-time')!;
        const description: string = interaction.options.getString('description')!;
        const link: string = interaction.options.getString('link')!;
        const background: Attachment = interaction.options.getAttachment('background')!;
