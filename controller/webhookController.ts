...
export class WebhookController {
    ...
    static async SendLivePoll(req: Request, res: Response) {
        ...
        if (!req.body.evento) {
            ...
            return res.status(500).json({error: "Para envir a mensagem é necessário especificar o 'evento' com a turma e título do evento separados por ' - '"});
        }
        ...
        if (!role) {
            ...
            return res.status(500).json({error: "Cargo da turma não encontrado"});
        }
